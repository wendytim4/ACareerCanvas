...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "INSERT INTO work_experience(job_title, country,city, organization_name, start_date, end_date,job_description,job_descriptionone,job_descriptiontwo,student_id)
            VALUES (?, ?, ?, ?, ?,?,?,?,?,?)";
